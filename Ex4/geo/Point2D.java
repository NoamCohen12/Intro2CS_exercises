...
public class Point2D{
	...
	public void rotate(Point2D cen, double angleDegrees) {
		...
		double newX = cen._x + (this._x - cen._x)*Math.cos(angleDegrees) - (this._y - cen._y)*Math.sin(angleDegrees);
		double newY = cen._y + (this._x - cen._x)*Math.sin(angleDegrees) + (this._y - cen._y)*Math.cos(angleDegrees);
		this._x = newX;
		this._y = newY;	
		/////////////////////////////////////////
	}
